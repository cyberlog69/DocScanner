...
object CategoryClassifier {
    ...
    /**
     * Classifies the given [ocrText] and returns the most appropriate [DocumentCategory].
     * If no strong match is found, returns [fallbackCategory].
     */
    fun classify(ocrText: String, fallbackCategory: DocumentCategory = DocumentCategory.OTHER): DocumentCategory {
        if (ocrText.isBlank()) return fallbackCategory

        val lowerText = ocrText.lowercase(Locale.getDefault())
